...
from apps import home_page, stock_overview, calculator, news_module, newPage# importing app modules
...
#app.add_app("Tweets", tweets.app)
app.add_app("newPage", newPage.app)
